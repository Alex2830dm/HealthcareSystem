      ...
      <ul class="navbar-nav mr-auto">
        ...
        <h6>
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle text-white" data-toggle="dropdown" href="{{url('practicas/quienes-somos')}}" role="button" aria-haspopup="true" aria-expanded="false">¿Quienes Somos?</a>
            <div class="dropdown-menu">
              <a class="dropdown-item" href="{{url('practicas/quienes-somos')}}">¿Quienes Somos?</a>
              <a class="dropdown-item" href="{{url('practicas/unete-hs')}}">Unete a Healthceare System</a>              
            </div>
          </li>
        </h6>
        <h6>
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle text-white" data-toggle="dropdown" href="{{url('practicas/primeros-auxilios')}}" role="button" aria-haspopup="true" aria-expanded="false">Servicios</a>
            <div class="dropdown-menu">
              <a class="dropdown-item" href="{{url('practicas/primeros-auxilios')}}">Primeros Auxilios</a>
              <a class="dropdown-item" href="{{url('practicas/emergencias')}}">Emergencias</a>                        
            </div>
          </li>
        </h6>  
        <h6>
        ...
        <div class="top-right links">
            @auth
              <button type="button" class="btn btn-outline-secondary">
                <a href="{{ url('practicas/home') }}" class="text-white">Perfil</a>
              </button>                
            @else
